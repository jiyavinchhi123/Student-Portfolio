...
export default function Header({ name, themeColor, theme }) {
  ...
  return (
    <section
      id="hero"
      className={`relative min-h-screen flex items-center py-24 sm:py-28 ${
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 w-full">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          >
            ...
            >
              <img
                ...
                className={`relative h-[clamp(230px,70vw,520px)] max-w-full w-auto ${
          ...
          >
            ...
            <h2
              className={`font-bebas text-[clamp(3.4rem,18vw,9.5rem)] leading-none font-normal tracking-wide ${
            ...
            >
              ...
              <a
                ...
                className={`inline-flex w-full sm:w-auto items-center justify-center px-6 py-3 rounded-full text-sm font-semibold border transition hover:scale-105 shadow-[0_0_18px_rgba(59,130,246,0.35)] ${
                  isDark
            ...
            >
              <a
                className="hover:scale-105 hover:text-blue-300 dark:hover:text-blue-500 transition"
